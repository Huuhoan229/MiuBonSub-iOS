...
# Replace VideosView up to DictionaryView
...
# Replace SeriesPosterCard up to SeriesCard (this captures the OLD InlineVideoPlayer AND the OLD VideoPlayerSheet!)
p_start = content.find("struct SeriesPosterCard: View {")
p_end_token = "struct SeriesCard: View {"
